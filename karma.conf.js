...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/session/sessionModule.js',
			'app/modules/session/sessionCtrl.js',
			...
			'app/modules/article/articlesModule.js',
			'app/modules/article/articlesCtrl.js',
			'app/modules/article/articlesRoute.js',
			'app/modules/article/articleService.js',
			'app/modules/article/articles-test.js',
		],
